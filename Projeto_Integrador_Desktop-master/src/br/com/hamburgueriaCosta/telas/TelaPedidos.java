...
public class TelaPedidos extends javax.swing.JInternalFrame {
    ...
    private void consultar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtnomeproduto.setText(rs.getString(5));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 140, 230, 360));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 230, 360));
        ...
        jPanel4.add(btnexcluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, -1, -1));
        ...
        txtquantidade.setMinimumSize(new java.awt.Dimension(16, 20));
        txtquantidade.setName(""); // NOI18N
        jPanel3.add(txtquantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 60, -1));
        ...
        jLabel14.setText("Valores dos produtos");
        jPanel3.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, -1, -1));

        txtpreco.setEnabled(false);
        jPanel3.add(txtpreco, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 230, -1));
        ...
        jPanel3.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 250, 10));

        txtnomeproduto.setColumns(20);
        txtnomeproduto.setRows(5);
        txtnomeproduto.setEnabled(false);
        jScrollPane2.setViewportView(txtnomeproduto);

        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 230, 120));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, 250, 360));
    ...
    private void btnexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexcluirActionPerformed
        // TODO add your handling code here:
                int confirmar = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja remover este pedido ?", "Atenção", JOptionPane.YES_NO_OPTION);
